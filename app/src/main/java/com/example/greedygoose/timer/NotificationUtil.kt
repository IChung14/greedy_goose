...
class NotificationUtil {
    companion object {
        ...
        fun showTimerRunning(): NotificationManager {
            val notifBuilder = getNotificationBuilder(mod.get_timer_page_context(), RUNNING_CHANNEL_ID, false)
            notifBuilder.setContentTitle("Timer is running")
            notifBuilder.setContentText("00:00:01")
            val notifManager = mod.get_timer_page_context().getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
